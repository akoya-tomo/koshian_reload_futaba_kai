...
## インストール
**GitHub**  
[![インストールボタン](images/install_button.png "クリックでアドオンをインストール")](https://github.com/akoya-tomo/koshian_reload_futaba_kai/releases/download/v2.6.2/koshian_reload_futaba_kai-2.6.2-fx.xpi)

※v1.10.0からアドオンのアクセス許可にログサイト(`www.ftbucket.info`)が追加になります。（該当スレのログの有無の確認）  
※v1.9.0からアドオンのアクセス許可にログサイト(`tsumanne.net`)が追加になります。（該当スレのログの有無の確認）  
...
* v1.10.0 2019-05-04
  - ログサイト(`www.ftbucket.info`)に該当スレのログが無いときはリンクを表示しないように修正
* v1.9.0 2019-05-02
  - ログサイト(`tsumanne.net`)に該当スレのログが無いときはリンクを表示しないように修正
* v1.8.0 2019-04-26
  - ログサイトを追加
* v1.7.2 2019-03-05
